...
export const metadata: Metadata = {
  ...
  description:
    "Can you buy or sell a home in Calgary with Bitcoin? Chan breaks down how crypto real estate transactions work in Canada — the process, tax implications, real Calgary examples, and a live BTC/CAD calculator.",
};
          ...
          <div className="space-y-4">
            {[
              ...
              },
              {
                ...
                body: "No major Canadian bank accepts cryptocurrency as a down payment source. A buyer using Bitcoin must pay the full purchase price — no 5% down with a crypto top-up. Some alternative lenders will accept documented crypto-sourced funds that have been converted to CAD and held untouched in a Canadian bank account for 3–6 months (\"seasoning\").",
              },
              {
                icon: "📂",
          ...
          <div className="space-y-3">
            {[
              ...
              },
              {
                ...
                body: "Transfer from cold wallets or offshore exchanges to a registered Canadian exchange (Kraken, Coinbase, Wealthsimple Crypto, Newton, NDAX). Compile complete acquisition records: dates, amounts paid in CAD, transaction IDs.",
              },
              {
                step: "3",
