      ...
      <div className="max-w-6xl mx-auto px-6 py-14 grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div>
          ...
          <div className="flex gap-4 mt-6">
            {/* Facebook */}
            <a
              href="https://www.facebook.com/livingwithchan"
              target="_blank"
            ...
            {/* TikTok */}
            <a
              href="https://www.tiktok.com/@livingwithchan"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="TikTok"
              className="text-stone-400 hover:text-white transition-colors"
            ...
            {/* LinkedIn */}
            <a
              href="https://www.linkedin.com/in/chankawaguchi"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="LinkedIn"
              className="text-stone-400 hover:text-white transition-colors"
            ...
            {/* X (Twitter) */}
            <a
              href="https://x.com/livingwithchan"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="X"
              className="text-stone-400 hover:text-white transition-colors"
